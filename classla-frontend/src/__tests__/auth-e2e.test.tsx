...
const AuthStateDisplay = () => {
  ...
  return (
    <div>
      <div data-testid="auth-loading">{loading ? 'loading' : 'not-loading'}</div>
...
describe('Authentication End-to-End Tests', () => {
  ...
  describe('Complete Authentication Flow', () => {
    it('should handle complete login flow from sign-in to dashboard', async () => {
      ...
      expect(screen.getByText('Sign In to Classla LMS')).toBeInTheDocument();

      // Click sign-in button
      const signInButton = screen.getByRole('button', { name: 'Sign In with WorkOS' });
    ...
    it('should handle logout flow', async () => {
      ...
      expect(screen.getByText('Welcome to Classla LMS')).toBeInTheDocument();
  ...
  describe('Error Handling', () => {
    it('should handle authentication errors gracefully', async () => {
      mockAuthService.getCurrentUser.mockResolvedValue(null);
      mockAuthService.getSessionInfo.mockResolvedValue(null);
      mockAuthService.signInWithPassword.mockRejectedValue(new Error('Login failed'));
    ...
    it('should handle callback errors', async () => {
      ...
      window.history.pushState({}, '', '/auth/callback?code=invalid-code&state=test-state');
    ...
    it('should handle network errors during authentication', async () => {
      ...
      mockAuthService.getSessionInfo.mockRejectedValue(new Error('Network error'));
